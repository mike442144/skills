...
| Need to extract multi-year MD&A content from annual report PDFs | `cninfo-annual-report-extraction.md` | TOC-vs-content pitfall, section number variation, end-marker detection, keyword filtering |
