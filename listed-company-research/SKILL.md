...
**File naming**:
- A-share reports: `[stock code]_[company name]_深度研究报告_YYYYMMDD.md` (e.g., `002091_江苏国泰_深度研究报告_20260427.md`)
- HKEX reports: `[stock code]_[company name]_深度研究报告_YYYYMMDD.md` (e.g., `09992_泡泡玛特_深度研究报告_20260428.md`)
- US reports: `[ticker]_[company name]_深度研究报告_YYYYMMDD.md` (e.g., `LULU_lululemon_深度研究报告_20260423.md`)
