...
5. **HKEX reports**: HK-listed company MD&A (under IFRS) is typically less structured than A-share. Also, much substantive business information (segment performance, project updates, outlook) often sits in the 业绩回顾 / Business Review section rather than in 管理层讨论与分析 — extract and review both, not just MD&A. Supplement with earnings call transcripts and investor presentations for management narrative.
